                                            ...
                                            <div className="inner flex  flex-col justify-between items-start ps-5 ">
                                                ...
                                                <div>
                                                    <button
                                                        ...
                                                        type="button"
                                                        className="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 text-center  my-2">
                                                        Remove Item
                                                    </button>
                                                </div>
                                        ...
                                        <div className='w-full md:w-1/6'>
                                            <div className="inner flex flex-wrap justify-center items-center gap-5">
                                                <button
                                                    ...
                                                    type="button"
                                                    className="text-green-700 hover:text-white border border-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 text-center  my-2">
                                                    +
                                                </button>
                                                ...
                                                <button
                                                    ...
                                                    type="button"
                                                    className={` ${item.count == 0 ? "disabled:opacity-25" : ""} "text-green-700 hover:text-white border border-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 text-center  my-2"`}>
                                                    -
                                                </button>
                                            </div>
                                        </div>
