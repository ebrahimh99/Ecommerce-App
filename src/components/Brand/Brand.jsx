        ...
        <div className="flex flex-wrap justify-start items-center">
          {data?.data.data.map((item, idx) => (
            <div key={idx} className="w-full sm:w-1/2 md:w-1/4 p-4">
              <div
                className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-lg  hover:shadow-lg hover:shadow-green-500/50 transition-shadow duration-300"
              ...
              >
                ...
                <div className="p-5">
                  <h5 className="mb-2 text-center text-2xl font-bold tracking-tight text-green-600">
                    {item.name}
                  </h5>
                </div>
              </div>
        ...
        <div id="default-modal" className="fixed inset-0 flex justify-center items-start bg-[rgba(0,0,0,0.5)] z-50">
          <div className="relative p-4 w-full max-w-2xl max-h-full">
            <div className="relative bg-white rounded-lg shadow ">
              <div className="flex items-center justify-end p-4 border-b rounded-t ">
                <button
                  type="button"
              ...
              <div className="p-4 space-y-4 flex items-center justify-between">
                <div>
                  <p className="ps-5 text-3xl leading-relaxed text-green-700 ">
