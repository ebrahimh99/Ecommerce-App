                    ...
                    <div className='w-full sm:w-full md:w-2/3 lg:w-2/3'>
                        <div className="inner px-5">
                            ...
                            <button
                                onClick={addProduct}
                                type="button"
                                className="w-full mt-4 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">
